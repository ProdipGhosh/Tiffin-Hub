        ...
        <main className="flex-1 flex flex-col overflow-hidden bg-white">
          ...
          <div className="flex items-center gap-3 px-5 py-2 border-b border-gray-100 shrink-0">
            ...
            <div className="leading-tight">
              <p className="text-sm font-semibold text-gray-800">Tiffin Hub Refund Policy v1.0</p>
          ...
          <div className="flex-1 overflow-hidden relative bg-white">
            <iframe
              src="/refund-policy.pdf#toolbar=0&navpanes=0&scrollbar=1&zoom=page-width"
              title="Tiffin Hub Refund Policy"
              style={{
                position: "absolute",
                top: 0,
                left: "-60px",
