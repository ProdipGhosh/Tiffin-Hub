        ...
        <main className="flex-1 flex flex-col overflow-hidden bg-white">
          ...
          <div className="flex items-center gap-3 px-5 py-2 border-b border-gray-100 shrink-0">
            ...
            <div className="leading-tight">
              <p className="text-sm font-semibold text-gray-800">Tiffin Hub Terms of Use v1.0</p>
              <p className="text-xs text-gray-400">PDF Document</p>
            </div>
            <a href="/terms-of-use.pdf" download
          ...
          <div className="flex-1 overflow-hidden relative bg-white">
            <iframe
              src="/terms-of-use.pdf#toolbar=0&navpanes=0&scrollbar=1&zoom=page-width"
              title="Tiffin Hub Terms of Use"
              style={{
                position: "absolute",
                top: 0,
                left: "-60px",
